...
#ifndef SPRAYBOT_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
#define SPRAYBOT_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
...
namespace spraybot_lifecycle_manager
{

using nav2_msgs::srv::ManageLifecycleNodes;
/**
 * @class spraybot_lifecycle_manager::LifecycleManager
...
public:
  /**
   * @brief A constructor for spraybot_lifecycle_manager::LifecycleManager
   * @param options Additional options to control creation of the node.
   */
  explicit LifecycleManager(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for spraybot_lifecycle_manager::LifecycleManager
   */
  ~LifecycleManager();
...
#endif  // SPRAYBOT_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
